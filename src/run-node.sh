...
GITHUB_TARBALL_URL="${GITHUB_TARBALL_URL:-https://github.com/augusthindenes/inf3200/releases/download/latest/webserver-v0.0.8-x86_64-unknown-linux-gnu.tar.gz}
